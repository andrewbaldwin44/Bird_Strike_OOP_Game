...
let bonus_chance = BONUS_CHANCE;
const BONUS_DIFFICULTY = 50;
...
let heart_chance = HEART_CHANCE;
const HEART_DIFFICULTY = 5;
...
const HEART_SOUND = new Audio(`${SOUND_ROOT}/heart.mp3`);
const FULL_HEART_SOUND = new Audio(`${SOUND_ROOT}/fullheart.mp3`);

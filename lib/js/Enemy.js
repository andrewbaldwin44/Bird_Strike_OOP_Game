class Enemy extends TopdownEntity {
  constructor(enemySpot, image, speed, width = ENEMY_WIDTH, height = ENEMY_HEIGHT) {
    super(enemySpot, image, width, height);
  ...
  shoot() {
    this.bullets.push(new Bullet(this, ENEMY_WIDTH - ENEMY_BULLET_OFFSET, ENEMY_HEIGHT,
                                 enemy_bullet_image));
  }
